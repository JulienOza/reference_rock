...
(5,'../src/assets/photos/aude.webp','Aude','Chant','La voix du groupe ! Elle est aujourd''hui accompagnée par une technicienne vocale après une formation en guitare classique au conservatoire. Elle n''était pas disposée à faire du rock. Son univers de balades en guitare-voix est à l''opposé de ce qu''elle chante avec Reference Rock. Ce qu''on peut dire, c''est que ce n''est pas elle qui a adopté le rock, c''est le rock qui l''a adoptée. Elle vit chaque prestation avec une énergie débordante et incarne chaque morceau. Sa voix grave donne un côté mystérieux et surprenant aux titres repris. Avec plus d''une corde à son arc, on doit aussi vous dire qu''elle compose ses propres chansons...','Lorem ipsum dolor sit amet, consectetur adipiscing elit.');
